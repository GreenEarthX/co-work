...
export interface CustomerProject {
  id: string;
  name: string;
  molecule: 'H2' | 'NH3' | 'e-Methanol' | 'SAF' | 'e-NG';
  location: string;
  country: string;
  lat: number;
  lng: number;
...
export const CUSTOMER_PROJECTS: CustomerProject[] = [
  // ── 1 · H2 · Bremen, Germany ─────────────────────────────────────────────
  {
    ...
    bankability: {
      ...
      capital_status: [
        { type: 'GRANTS_TA',            name: 'Grants & TA',              amount: '€12M',  is_unlocked: true,  gating_gates: [],                                               progress_pct: 100 },
        { type: 'SEED_VC_ANGEL',        name: 'Seed / VC',                amount: '€18M',  is_unlocked: true,  gating_gates: [],                                               progress_pct: 100 },
        { type: 'STRATEGIC_EQUITY',     name: 'Strategic Equity',         amount: '€55M',  is_unlocked: false, gating_gates: ['G1_GRID_UTILITIES'],                            progress_pct: 67  },
        { type: 'SENIOR_DEBT',          name: 'Senior Debt',              amount: '€135M', is_unlocked: false, gating_gates: ['G5_EPC_RISK_PRICED', 'G1_GRID_UTILITIES'],      progress_pct: 73  },
      ],
    },
  },
  ...
  // ── 2 · NH3 · Rotterdam, Netherlands ─────────────────────────────────────
  {
    ...
    bankability: {
      ...
      capital_status: [
        { type: 'GRANTS_TA',            name: 'Grants & TA',              amount: '€20M',  is_unlocked: true,  gating_gates: [],                                                          progress_pct: 100 },
        { type: 'STRATEGIC_EQUITY',     name: 'Strategic Equity',         amount: '€120M', is_unlocked: false, gating_gates: ['G4_OFFTAKE_BANKABLE'],                                     progress_pct: 50  },
        { type: 'DFI_GUARANTEES',       name: 'DFI Guarantees',           amount: '€45M',  is_unlocked: false, gating_gates: ['G0_SITE_RIGHTS', 'G4_OFFTAKE_BANKABLE'],                  progress_pct: 62  },
        { type: 'SENIOR_DEBT',          name: 'Senior Debt',              amount: '€195M', is_unlocked: false, gating_gates: ['G8_AUDIT_GRADE_MODEL', 'G4_OFFTAKE_BANKABLE'],            progress_pct: 55  },
      ],
    },
  },
  ...
  // ── 3 · e-Methanol · San Sebastián, Spain ────────────────────────────────
  {
    ...
    bankability: {
      ...
      capital_status: [
        { type: 'PROJECT_EQUITY',       name: 'Project Equity',   amount: '€42M',  is_unlocked: false, gating_gates: ['G4_OFFTAKE_BANKABLE', 'G7_INSURANCE_BOUND'],              progress_pct: 79  },
        { type: 'SENIOR_DEBT',         name: 'Senior Debt',       amount: '€98M',  is_unlocked: false, gating_gates: ['G8_AUDIT_GRADE_MODEL', 'G10_FINANCIAL_CLOSE_CP'],          progress_pct: 53  },
        { type: 'DFI_GUARANTEES',      name: 'DFI Guarantees',    amount: '€25M',  is_unlocked: true,  gating_gates: ['G4_OFFTAKE_BANKABLE'],                                    progress_pct: 100 },
        { type: 'DEBT_DRAWDOWN',       name: 'Debt Drawdown',     amount: '€98M',  is_unlocked: false, gating_gates: ['G10_FINANCIAL_CLOSE_CP'],                                 progress_pct: 25  },
      ],
    },
  },
  ...
  // ── 4 · SAF · Wales, UK ──────────────────────────────────────────────────
  {
    ...
    bankability: {
      ...
      capital_status: [
        { type: 'GRANTS_TA',            name: 'Grants & TA',              amount: '€8M',   is_unlocked: true,  gating_gates: [],                                                     progress_pct: 100 },
        { type: 'SEED_VC_ANGEL',        name: 'Seed / VC',                amount: '€22M',  is_unlocked: false, gating_gates: ['G0_SITE_RIGHTS'],                                     progress_pct: 50  },
        { type: 'STRATEGIC_EQUITY',     name: 'Strategic Equity',         amount: '€90M',  is_unlocked: false, gating_gates: ['G0_SITE_RIGHTS', 'G3_TECH_VENDOR_LOCKED', 'G4_OFFTAKE_BANKABLE'], progress_pct: 38  },
        { type: 'SENIOR_DEBT',          name: 'Senior Debt',              amount: '€170M', is_unlocked: false, gating_gates: ['G4_OFFTAKE_BANKABLE', 'G3_TECH_VENDOR_LOCKED'],       progress_pct: 32  },
      ],
    },
  },
  ...
  // ── 5 · e-NG · Le Havre, France ──────────────────────────────────────────
  {
    ...
    bankability: {
      ...
      capital_status: [
        { type: 'GRANTS_TA',            name: 'Grants & TA',              amount: '€15M',  is_unlocked: true,  gating_gates: [],                 progress_pct: 100 },
        { type: 'SEED_VC_ANGEL',        name: 'Seed / VC',                amount: '€20M',  is_unlocked: true,  gating_gates: [],                 progress_pct: 100 },
        { type: 'STRATEGIC_EQUITY',     name: 'Strategic Equity',         amount: '€60M',  is_unlocked: true,  gating_gates: [],                 progress_pct: 100 },
        { type: 'DFI_GUARANTEES',       name: 'DFI Guarantees',           amount: '€30M',  is_unlocked: true,  gating_gates: [],                 progress_pct: 100 },
        { type: 'SENIOR_DEBT',          name: 'Senior Debt',              amount: '€120M', is_unlocked: true,  gating_gates: [],                 progress_pct: 100 },
      ],
    },
  },
];
