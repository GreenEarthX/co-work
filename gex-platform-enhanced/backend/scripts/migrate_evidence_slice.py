...
Evidence & bankability slice — copy SQLite -> PostgreSQL, then prove parity.
    ...
    DATABASE_URL=postgresql://... python scripts/migrate_evidence_slice.py [--execute]
...
SLICE_TABLES: dict[str, tuple[str, ...]] = {
    "bankability_evidence": ("id",),
    "bankability_snapshots": ("project_id",),
    "evidence_documents": ("id",),
    "evidence_events": ("id",),
    "evidence_ledger": ("evidence_id",),
}
SEQUENCE_TABLES = ("bankability_evidence", "evidence_documents", "evidence_events")
