...
from pf_engine.core.gabillon import (
    get_gabillon_model,
    GabillonParams,
    PriceObservation,
    SEED_PARAMS,
)
from pf_engine.core.price_lineage import PriceLineageEngine
from pf_engine.core.debt.tranche import (
...
# Tenors served by GET /term-curve. Module-level so tests exercise the real list.
TERM_CURVE_TENORS_MONTHS = [1, 3, 6, 9, 12, 18, 24, 30, 36, 48, 60]
...
async def get_term_curve(
    ...
    tenors = TERM_CURVE_TENORS_MONTHS
